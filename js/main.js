...
function selectSign() {
    for(var i=0; i<myDropdown.length; i++) {
      console.log(myDropdown[i].sign);
      console.log(myDropdown[i].picture);
      console.log(myDropdown[i].description);
};
...
var description = document.getElementById("description)");
      ...
      sign.innerText = myDropdown.sign;
      picture.src = myDropdown.picture;
      description.innerText = myDropdown.description;
